...
void FooterBar::draw(bool is_compact, bool is_copy_mode_active, bool is_auto_hop_mode_active, bool can_cycle_url, const std::string& temp_msg) {
    ...
    if (!temp_msg.empty()) {
        ...
        footer_text = " [P] Mode [A] Auto-Hop [↑↓] Nav [↵] Mute " + cycle_text + "[D] Duck [⇥] Panel [F] Fav [C] Search [Q] Quit ";
    }
